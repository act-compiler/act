...
An **accelerator kernel** is a program written using the accelerator's ISA instructions. Similar to how you write assembly programs for CPUs, you write kernels for AI accelerators -- but at a much coarser granularity (entire tensor operations rather than scalar operations).
